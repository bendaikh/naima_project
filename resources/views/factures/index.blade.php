                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 text-center text-sm">
                                <div class="flex justify-center gap-2">
                                    ...
                                    <a href="{{ route('factures.print', $f) }}" target="_blank" class="inline-flex items-center justify-center rounded-lg bg-green-500 w-8 h-8 text-white hover:bg-green-600 transition-colors" title="Imprimer">
